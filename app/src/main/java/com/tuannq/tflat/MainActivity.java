...
//        crud.insertWord(new Word(1,"turtle","Con rùa", "."));
//        crud.insertWord(new Word(1,"horse","Con ngựa", "."));
//        crud.insertWord(new Word(1,"Tiger","Con hổ", "."));
//        crud.insertWord(new Word(1,"Lion","Con sư tử", "."));
//        crud.insertWord(new Word(1,"duck","Con vịt", "."));
